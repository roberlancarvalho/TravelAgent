...
query = """
Vou viajar para Londres em agosto de 2024. Quero que faça um roteiro de viagem para mim com eventos que irão ocorrer com a 
data da viagem e com o preço de passagem de São Paulo para Londres.
"""
...
def supervisrAgent(query, llm, webContext, relevant_documents):
    prompt_template = """
...
def getResponse(query, llm):
    ...
    response = supervisrAgent(query, llm, webContext, relevant_documents)
    return response
